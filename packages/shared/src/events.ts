...
const severityByEventType: Partial<Record<AuditEventType, AuditSeverity>> = {
  ...
  device_infrastructure_changed: "notice",
  infrastructure_access_requested: "notice",
  infrastructure_access_granted: "notice",
  infrastructure_access_expired: "notice",
  infrastructure_access_revoked: "notice",
  ...
  ticket_created: "notice",
  ticket_updated: "notice",
  ticket_comment_added: "notice",
  ...
  after_hours_run_requested: "notice",
  after_hours_run_queued: "notice",
  ...
  asset_linked: "notice",
  asset_unlinked: "notice",
  device_model_created: "notice",
  device_model_updated: "notice",
  device_model_deleted: "notice",
  custom_field_definition_created: "notice",
  ...
  agent_service_created: "notice",
  agent_service_updated: "notice",
  agent_service_deleted: "notice",
  agent_service_assigned: "notice",
  agent_service_unassigned: "notice",
  device_command_completed: "notice",
}

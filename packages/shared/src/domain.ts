...
export const auditEventTypeSchema = z.enum([
  ...
  "device_archived",
  "device_unarchived",
  "device_infrastructure_changed",
  "infrastructure_access_requested",
  "infrastructure_access_granted",
  "infrastructure_access_expired",
  "infrastructure_access_revoked",
  "site_created",
  "site_updated",
  "site_deleted",
  ...
  "agent_service_created",
  "agent_service_updated",
  "agent_service_deleted",
  "agent_service_assigned",
  "agent_service_unassigned",

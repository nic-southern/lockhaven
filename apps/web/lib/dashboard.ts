...
const statusLabels: Record<string, string> = {
  ...
  device_infrastructure_changed: "Infrastructure updated",
  infrastructure_access_requested: "Infrastructure access requested",
  infrastructure_access_granted: "Infrastructure access granted",
  infrastructure_access_expired: "Infrastructure access expired",
  infrastructure_access_revoked: "Infrastructure access ended",
  ok: "Healthy",
  Down: "Down",
  winrm_https: "WinRM",
  vnc: "VNC",

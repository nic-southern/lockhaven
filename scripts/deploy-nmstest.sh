...
VNC_HOSTNAME="${VNC_HOSTNAME:-vnc.example.com}"
VNC_PROXY_TARGET_HOST="${VNC_PROXY_TARGET_HOST:-10.80.20.11}"
VNC_PROXY_TARGET_PORT="${VNC_PROXY_TARGET_PORT:-5900}"
VNC_PROXY_LISTEN_PORT="${VNC_PROXY_LISTEN_PORT:-15900}"
...
ssh "${SSH_OPTS[@]}" "$REMOTE_HOST" "REMOTE_APP_DIR='$REMOTE_APP_DIR' APP_HOSTNAME='$APP_HOSTNAME' GUAC_HOSTNAME='$GUAC_HOSTNAME' VNC_HOSTNAME='$VNC_HOSTNAME' VNC_PROXY_TARGET_HOST='$VNC_PROXY_TARGET_HOST' VNC_PROXY_TARGET_PORT='$VNC_PROXY_TARGET_PORT' VNC_PROXY_LISTEN_PORT='$VNC_PROXY_LISTEN_PORT' bash -s" <<'REMOTE'
set -euo pipefail
...
VNC_PROXY_TARGET_HOST=${VNC_PROXY_TARGET_HOST}
VNC_PROXY_TARGET_PORT=${VNC_PROXY_TARGET_PORT}
VNC_PROXY_LISTEN_PORT=${VNC_PROXY_LISTEN_PORT}
